...
Use these labels consistently across Markdown, JSON, CSV, SARIF, OPTRS, VXDF decisions, and delivery packs. Detailed vocabulary is defined in `../1-prompts/staged/00-run-control-and-evidence-model.md`.
