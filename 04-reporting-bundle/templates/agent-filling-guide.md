...
Use the labels defined in `../../03-prompt-guidance/staged/00-run-control-and-evidence-model.md`. Do not overclaim. Static evidence confirms code or design defects; it does not, by itself, confirm deployed exploitability.
